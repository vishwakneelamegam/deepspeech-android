package com.example.deepspeechtestjava;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        this._tfliteModel.setText(Environment.getExternalStorageDirectory().getAbsolutePath() + "/" + "deepspeech-0.9.3-models.tflite");
        this._tfliteStatus.setText("Ready, waiting ...");
        this._audioFile.setText(Environment.getExternalStorageDirectory().getAbsolutePath() + "/" + "audio.wav");
